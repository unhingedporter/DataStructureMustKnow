...
console.log(
  `The status for string unique character is ${str.containsOnlyUniqueCharacter(
    "abcabc"
  )}`
);
console.log(
...
console.log(
  `The status for string unique character is ${str.containsPermutations(
    "abcdef",
    "feabcd"
  )}`
);
...
console.log(
  `The status for string unique character is ${str.stringCompression(
    "aaaaaaaaaabbbcccdefgggghhaaa"
  )}`
);
